...
def getDensityMap(BoxWeightList, roi,
    ...
    return (
        np.array(range(len(density))) / resolution * (roi[up] - roi[low]),
        sliding_average(density, slideavg_windowsize))
...
if __name__ == "__main__":
    res = parsePDF_PDFFigures2(r"W:\Personal_Project\metaunitech\arxiv_daily\demo2.pdf")
    print("HRE")
